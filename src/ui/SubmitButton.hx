...
/**
 * Кнопка завершить игру и отправить очки.
 * @author VolkovRA
 */
class SubmitButton extends Button 
{
	...
	public function new() {
		...
		label.defaultTextFormat = new TextFormat(Assets.getFont("assets/font/CgBernhardtBd.ttf").fontName, 15, 0xffffff, false, false, false, null, null, TextFormatAlign.CENTER, null, null, null, -5);
