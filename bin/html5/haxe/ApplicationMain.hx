...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Flipit", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Flipit", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "17";
		app.meta["company"] = "VolkovRA";
		app.meta["file"] = "Flipit";
		app.meta["name"] = "Flip it";
		app.meta["packageName"] = "Flipit";
